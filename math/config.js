...
//                                                          // URL to use for references
  ...
  "SVG": {
    ...
    //
    merrorStyle: {
      fontSize:"90%", color:"#C00", background:"#FF8", padding:"3px"
    },
  ...
  //============================================================================
  //
  //  These parameters control the contextual menus that are available on the mathematics within the page (provided the showMathMenu value is true above).
  MathEvents: {
    //
